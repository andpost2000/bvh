...
<body <?php body_class(); ?>>
  ...
  <div id="page" class="site">
    ...
    <div class="sideContent">
      <!-- <?php if (get_field('blog', 'options')) : ?>
				<a class="blogBtn" href="<?php the_field('blog', 'options'); ?>">Blog</a>
			<?php endif; ?> -->
      <div class="socialShareRow my">
        ...
        <div class="socialShareWrap my" id="socialShareCls">
          ...
          <a href="mailto:?Subject=Corfu Next | <?php the_title(); ?> &amp;Body=You%20might%20be%20interested!%20 <br/><?php the_permalink() ?>">
            <i class="fa fa-envelope"></i>
          </a>
          <a href="https://twitter.com/intent/tweet?text=Bella Vista - <?php the_title(); ?>&hashtags=bellavistahotel&url=<?php the_permalink() ?>" target="_blank">
...
<div class="col-md-12 no_padding clearfix my-form">
	...
	<form action="https://bellavistacorfu.reserve-online.net/" method="post" class="my-calendar-form" target="_blank">
		<div class="calendar-input-wrap">
			...
			<div class="singleFormBox">
				...
				<input id="checkin" type="text" class="arrival" name="checkin" size="12" readonly maxlength="10" placeholder="<?php echo __('Check-In','bellavista'); ?>">
			</div>
			<div class="singleFormBox">
				<!-- <label for="checkin"><?php echo __('Check-Out','bellavista'); ?></label> -->
				<input id="checkout" type="text" class="departure" name="checkout" size="12" readonly maxlength="10" placeholder="<?php echo __('Check-Out','bellavista'); ?>">
			</div>
		</div>
...
var checkin = jQuery('#checkin').datepicker({
  format: 'dd-mm-yyyy',
  onRender: function(date) {
  ...
  checkin.hide();
  jQuery('#checkout')[0].focus();
}).data('datepicker');
var checkout = jQuery('#checkout').datepicker({
  format: 'dd-mm-yyyy',
  onRender: function(date) {
