...
<?php get_header(); ?>
<style>
li.single_slide { visibility: hidden; }

@media (min-width: 768px) {
.bxslider li {
  background-image: attr(data-img-url) !important;
}
}
</style>
...
<div class="container clearfix">
	<div class="customGrid">
		...
		<div class="col-md-12 no_padding clearfix headerRow ">
			<?php if ( get_field( 'video_toggle' ) ): ?>
				<?php if (get_field('type_of_video')): ?>
					<div class="video-container video">
						<iframe src="https://www.youtube.com/embed/<?php the_field('video_url_hero') ?>?rel=0&amp;&autoplay=1;controls=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>
					</div>
				<?php else: ?>
					<div class="video-container mp4 video">
						<?php the_field('mp4_video') ?>
					</div>
				<?php endif; ?>
					<div class="hero-title-section video">
						<h2><?php the_field('header_title') ?></h2>
						<span><?php the_field('header_subtitle') ?></span>
					</div>

			<?php else: // field_name returned false ?>
				<div class="video-container newGalleryWrap">
					<div class="newGalleryGrid">
						<?php
							...
							if( $images ): ?>
							    <div id="slider" class="">
							        <ul class="bxslider slides">
						                ...
						                <li class="single_slide" data-img-url="<?php echo $image['sizes']['large']; ?>" style="background-image:url('<?php echo $image['sizes']['large']; ?>'); background-size:cover; background-position:center center; height:650px;">
						                </li>
		...
		<div class="col-md-12 no_padding clearfix welcomeRow singleRow">
			<div class="col-md-3 no_padding clearfix welcomeRowLeft singleColUneven">
				<div style="background-image:url('<?php the_field('welcome_image_top'); ?>'); background-size:cover; background-position:center center; height:275px; margin-bottom:20px;"> </div>
				<div style="background-image:url('<?php the_field('welcome_image_bottom'); ?>'); background-size:cover; background-position:center center; height:275px;"> </div>
			</div>
		...
		<div class="col-md-12 no_padding clearfix roomRow singleRow">
			<div class="col-md-9 no_padding clearfix roomRowLeft singleColUneven" style="background-image:url('<?php $image = get_field('room_image'); echo($image['url']); ?>'); background-size:cover; background-position:center center; height:600px;">
			</div>
		...
		<div class="col-md-12 no_padding clearfix aboutRow singleRow">
			<div class="col-md-6 no_padding clearfix aboutRowLeft my singleCol imageBoxCol" style="background-image:url('<?php $image = get_field('about_image'); echo($image['sizes']['large']); ?>'); background-size:cover; background-position:center center; /*height:600px;*/">
				<div class="imageContentWrap">
					<h3><?php the_field('about_image_title'); ?></h3>
					<a class="blueBtn" href="<?php the_field('about_link','options'); ?>"><?php echo __('Read more','bellavista'); ?></a>
				</div>
			</div>
			<div class="col-md-6 no_padding clearfix aboutRowRight my singleCol">
				<div class="contentWrapper bg-logo">
					...
					<a class="arrowLink" href="<?php the_field('about_link','options'); ?>"><?php echo __('Learn more','bellavista'); ?></a>
				</div>
			</div>
		</div>
		<div class="col-md-12 no_padding clearfix locationRow singleRow">
			<div class="col-md-12 no_padding clearfix locationRow singleColUneven imageBoxCol my" style="background-image:url('<?php $image = get_field('location_image_full'); echo($image['url']); ?>'); background-size:cover; background-position:center center; height:600px;">
				<div class="imageContentWrap my">
					<h4><?php the_field('location_image_title'); ?></h4>
					<a class="blueBtn" href="<?php the_field('location_link','options'); ?>"><?php echo __('Read more','bellavista'); ?></a>
				</div>
			</div>
		</div>
		<div class="col-md-12 no_padding clearfix locationRow singleRow">
			<div class="col-md-8 no_padding clearfix locationRowLeft singleColUneven">
				<div class="contentWrapper bg-logo my">
					...
					<a class="arrowLink my" href="<?php the_field('location_link','options'); ?>"><?php echo __('Learn More','bellavista'); ?></a>
				</div>
				<!-- <img src="<?php echo get_stylesheet_directory_uri();?>/images/olive-branch-2.png"> -->
			</div>
			<div class="col-md-4 no_padding clearfix locationRowRight singleColUneven imageBoxCol" style="background-image:url('<?php $image = get_field('location_image'); echo($image['sizes']['large']); ?>'); background-size:cover; background-position:center center; height:600px;">
			</div>
		</div>

		<div class="col-md-12 no_padding clearfix facilitiesRow singleRow">
			<div class="col-md-4 no_padding clearfix facilitiesRowLeft singleCol" style="background-image:url('<?php $image = get_field('facilities_image'); echo($image['sizes']['large']); ?>'); background-size:cover; background-position:center center; height:650px;">
			</div>
		...
		<div class="col-md-12 no_padding clearfix breakfastRow singleRow">
			<div class="col-md-6 no_padding clearfix breakfastRowLeft singleColUneven imageBoxCol" style="background-image:url('<?php $image = get_field('breakfast_image'); echo($image['sizes']['large']); ?>'); background-size:cover; background-position:center center; height:600px;">
				<div class="imageContentWrap">
					<h3><?php the_field('breakfast_image_title'); ?></h3>
					<a class="blueBtn" href="<?php the_field('breakfast_link','options'); ?>"><?php echo __('Read more','bellavista'); ?></a>
				</div>
			</div>
			<div class="col-md-6 no_padding clearfix breakfastRowRight singleColUneven">
				<div class="contentWrapper bg-logo">
					...
					<a class="arrowLink" href="<?php the_field('breakfast_link','options'); ?>"><?php echo __('Learn More','bellavista'); ?></a>
				</div>
					...
					if( $my_query->have_posts() ) { $i = 1;
					    while ($my_query->have_posts()) : $my_query->the_post();
      						...
      						<?php if($i == 1) { ?>
				  				...
				  				<a href="javascript:void(0)" class="tablinks active" onclick="openTab(event, 'tab<?php echo $i; ?>')"><?php the_title(); ?></a>

      						<?php } else { ?>

			  					<a href="javascript:void(0)" class="tablinks" onclick="openTab(event, 'tab<?php echo $i; ?>')"><?php the_title(); ?></a>
      					...
      					<?php if($i == 1) { ?>
							...
							<div id="tab<?php echo $i; ?>" class="tabcontent" style="display: block!important;">
								...
								<div class="col-md-12 no_padding clearfix singleRoomRow singleRow">
									...
									<div class="col-md-6 no_padding clearfix singleRoomRight singleColUneven imageBoxCol" style="background-image:url('<?php echo $src; ?>'); background-size:cover; background-position:center center; /*height:600px;*/">
										<div class="imageContentWrap">
											<h4><?php the_title(); ?></h4>
											<a class="blueBtn" href="<?php the_field('request_form_link'); ?>"><?php echo __('Book Now','bellavista'); ?></a>
										</div>
									</div>
								</div>
